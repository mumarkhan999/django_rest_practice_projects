...
class UserSerializer(serializers.ModelSerializer):
    ...
    user_type = serializers.CharField(read_only=True, source='userprofile__user_type')
...
class ProcessAppointmentSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        queryset = User.objects.filter(userprofile__user_type='e', userprofile__saloon=saloon)
